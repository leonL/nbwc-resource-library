export default () => ({
  ...
  sortOrderOptions: [
    ...
    {id: 2, byField: 'dateAdded', direction: 'desc', en: "date posted (new to old)", fr: "date postée (nouveau à vieux)"},
    {id: 3, byField: 'dateAdded', direction: 'asc', en: "date posted (old to new)", fr: "date postée (ancien au nouveau)"}
  ],
  sortOrderId: 0,
  copy: [],
  locale: ''
